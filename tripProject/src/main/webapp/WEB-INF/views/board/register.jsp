...
<div id="slider">
		...
		<form method="post" action="/board/register.do" enctype="multipart/form-data">
		<input type="hidden" name="hits" value='<c:out value="${board.hits}"/>'>
		<input type="hidden" name="board_like" value='<c:out value="${board.board_like}"/>'>
		<c:choose>
			<c:when test="${empty sessionScope.user.userNum}">
			...
			<table border=1 width="100%">
				<tr>
					...
					<td><input type="text" name="board_title" style="width: 100%"></td>
				</tr>
				<tr>
				<td colspan="2"><textarea class="form-control" id="summernote" name="board_content"></textarea>
					</td>
				</tr>
			</table>
